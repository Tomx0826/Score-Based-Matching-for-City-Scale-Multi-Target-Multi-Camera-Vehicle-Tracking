...
from processor.processor4 import do_train
...
if __name__ == '__main__':
    ...
    train_loader, val_loader, num_query, num_classes, class_weights = make_dataloader(cfg)
    model = make_model(cfg, num_class=num_classes)

    loss_func, center_criterion = make_loss(cfg, num_classes=num_classes, class_weights=class_weights)
